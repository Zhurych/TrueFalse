...
@Inject constructor(
    ...
    private fun putGameResult(view: View) {
        ...
        answerResult = if (isTrue!! && view.id == R.id.buttonGameFragmentTrue) {
            true
        } else if (isTrue && view.id == R.id.buttonGameFragmentFalse) {
            false
        } else !(!isTrue && view.id == R.id.buttonGameFragmentTrue)
